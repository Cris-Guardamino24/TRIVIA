const preguntas = [
    {
        pregunta: "¿De quien es la canción?  Ella si se lleva bien con mis amigos nunca discutimos...",
        respuestas: ["Larsso", "Reik", "Romeo Santos", "Ozuna"],
        correcta: 0
    },
    {
        pregunta: "¿De quien es la canción?  No se si es casualidad que yo me sienta así siempre que tu estas cerquida...",
        respuestas: ["Ozuna", "Sebastian Yatra", "bad bunny", "Maluma"],
        correcta: 2
    },
    {
        pregunta: "¿De quien es la canción?  Estaba loca por probarte darte los besitos yo, ojala puedas quedarte...",
        respuestas: ["Greici", "Karol G", "Rosalia", "Tini"],
        correcta: 1
    }
];
...
function iniciarCronometro() {
  const contador = 10, cronometroDisplay = document.getElementById("cronometro")
...
function loadQuestions() {
  iniciarCronometro()
    if (preguntas.length > 0) {
        ...
        window.location.href = "../html/puntaje.html";
    }
}
